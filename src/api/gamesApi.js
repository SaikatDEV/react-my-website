...
export const all_games_url = () =>
  `${base_url}games?key=a77e904e38434e63ad0cce0d0ac43e1f&page_size=30`;
export const achievements_by_id_url = (id) =>
  `${base_url}games/${id}/achievements?key=a77e904e38434e63ad0cce0d0ac43e1f`;
export const game_detail_by_id_url = (id) =>
  `${base_url}games/${id}?key=a77e904e38434e63ad0cce0d0ac43e1f`;
//   https://api.rawg.io/api/games/2?key=a77e904e38434e63ad0cce0d0ac43e1f&screenshots
export const game_screenshot_by_id_url = (id) =>
  `${base_url}games/${id}?key=a77e904e38434e63ad0cce0d0ac43e1f&screenshots`;
